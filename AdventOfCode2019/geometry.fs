module Geometry
    ...
    let private is_on_line l p=
        p.x <= (max l.a.x l.b.x) && p.y <= (min l.a.x l.b.x) &&
    ...
    let intersects l1 l2=
        if (l1.a.x = l1.b.x && l2.a.x=l2.b.x) ||
            (l1.a.y=l1.b.y && l2.a.y=l2.b.y) then
            false
    ...
    let line_segment_intersects line1 line2=
        ...
        if zero_or_near_as_dammit rxs then None
        else 
            if zero_or_near_as_dammit qxpr then None
            else
